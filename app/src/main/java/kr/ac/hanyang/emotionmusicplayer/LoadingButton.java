...
public class LoadingButton extends View{
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArcPaint = new Paint();
        mArcPaint.setColor(0xFFfce456);
        mArcPaint.setStyle(Paint.Style.STROKE);
        mArcPaint.setStrokeWidth(10);
        mArcPaint.setAntiAlias(true);

        mFillCirclePaint = new Paint();
        mFillCirclePaint.setColor(0xFFfce456);
        mFillCirclePaint.setStyle(Paint.Style.FILL);
        mFillCirclePaint.setStrokeWidth(10);
        mFillCirclePaint.setAntiAlias(true);

        mCommonDrawable = getResources().getDrawable(R.drawable.ic_sentiment_satisfied_white_48dp);
